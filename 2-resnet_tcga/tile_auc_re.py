...
df = pd.read_csv('target/crctestresults101.csv')
output0 = df['output0']
output1 = df['output1']
output2 = df['output2']
output3 = df['output3']
outputs0 = output0-output1-output2-output3
outputs1 = output1-output0-output2-output3
outputs2 = output2-output0-output1-output3
outputs3 = output3-output0-output1-output2
